    ...
    <div className="categories-container">
      ...
      <div className="smallcontainer">
        <div className="sidebar">
          <h3 className="sidebar-title">Fruits</h3>
          <h2 className="sidebar-heading">Crunchy Irresistible Chips</h2>
          <p className="sidebar-description">
            Treat yourself to the ultimate snack experience with our perfectly
            seasoned chips.
          </p>
          <img
            src="../../assets/Logo.png"
      ...
      <div className="main-content">
        <header className="main-header">
          ...
          <button className="category-button">
            Categories <FaArrowRight className="arrow-icon" />
          </button>
        </header>
